...
$$
h_n = 2f_c\text{sinc}\left(2\pi f_cn\right), \quad n = -M \ \ldots \ M
$$
...
Из графика сравнения интерполяционного сигнала и сигнала с частотой дискретизации в два раза больше видно, что ошибка интерполяции возрастает при приближении мгновенной частоты сигнала к частоте Найквиста.
